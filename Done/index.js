    ...
    if (account === 'AD') {
        ...
        callback(elicit.confirmIntent(intentRequest.sessionAttributes, 'hangUp', {
            ...
            content: `<div>Let's call the Service Desk to check out your issue.
                    	...
                    	<div> Or <a href="http://fresnostate.edu/help/fac-staff/work-orders/general_workorder.html" target="_blank">Click Here</a>to submit a workorder.</div>
        ...
        if (account === 'myfresnostate' || account === 'blackboard' || account === "email" || account === "wifi" || account === "box") {
            if (knowId === null) {
                ...
                callback(elicit.confirmIntent(intentRequest.sessionAttributes, 'hangUp', {
                    contentType: 'PlainText',
                    content: `<div> Please call the Reigstar office for your ID and username. <a href="tel:559-278-2191">559.278.2191</a>. For more information <a target = "_blank" href = "http://fresnostate.edu/studentaffairs/registrar"> Click Here </a> </div>
								<div> After you have your ID number and username <a target = "_blank" href = "https://idm.fresnostate.edu/pwreset/"/> Click here</a> to reset your password. or head over to password.fresnostate.edu </div>
            ...
            callback(elicit.confirmIntent(intentRequest.sessionAttributes, 'hangUp', {
                 contentType: 'PlainText',
                content: `<div>Let's head over to Password Managment to change your password by <a target = "_blank" href = "https://idm.fresnostate.edu/pwreset/"> Clicking Here</a> or by heading over to password.fresnostate.edu.</div>
						    <div> If you need more information. Please call the Service Desk at <a href="tel:559-278-5000">559.278.5000</a></div>
							<div> Is there any else we assist with today?</div>`
                }));
            ...
            if (intentRequest.currentIntent.slots.Boxissue === "information") {
                ...
                callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                    ...
                    content: `<div> For box support please give the Service Desk a call at <a href="tel:559-278-5000">559.278.5000</a></div>
										<div> For more information on Box please <a target = "blank" href = "https://fresnostate.account.box.com/login">Click Here</a></div>`
                }));
                return;
            } else {
        ...
        if (account === 'myfresnostate' || account === 'blackboard') {
            if (knowId === null) {
                ...
                callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                    contentType: 'PlainText',
                    content: `<div> Please Call the Reigstar office for your ID and Username. <a href="tel:559-278-2191">559.278.2191</a> For more information <a target = "_blank" href = "http://fresnostate.edu/studentaffairs/registrar"/> Click Here </a> </div>
								<div> After you have access your your ID number and username please <a target = "_blank" href = "https://idm.fresnostate.edu/pwreset/"> Click here</a> to reset your password. </div>
								<div> If you still don't have access Please call <a href="tel:559-278-5000">559.278.5000</a>.</div>`
                }));
                return;
            } else {
                callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                    contentType: 'PlainText',
                    content: `<div>Let's head over to Password Managment to change your password. /div><div><a target = "_blank" href = "https://idm.fresnostate.edu/pwreset/"> Click Here </a>.</div>
...
function emailTrouble(intentRequest, callback) {
    ...
    if (email_issue === "Sending" || email_issue === "Receiving") {
        callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
            contentType: 'PlainText',
...
function clear_cache_cookies(intentRequest, callback) {
    ...
    if (browser === null) {
        ...
        if (browser === "safari") {
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: "PlainText",
                content: `<div>Here is how to clear your cache and cookies for Safari</div>
            ...
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: "PlainText",
                content: `<div>Here is how to clear your cache and cookies for Chrome.</div>
                                        <div>Steps to Clear Cache and Cookies:
                							<ol>
            ...
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: "PlainText",
                content: `<div>Here is how to clear your cache and cookies for Firefox.</div>
                                        <div>Steps to Clear Cache and Cookies:
                							<ol>
            ...
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: "PlainText",
                content: `<div>Here is how to clear your cache and cookies for Edge.</div>
                                        <div>Steps to Clear Cache and Cookies:
                							<ol>
                								<li>Select the <b>Hub icon</b> (three horizontal lines at top bar in front of a star), click the History menu option, and then click <b>Clear history.</b></li>
                								     <a href="https://preview.ibb.co/n4HjyK/edge_1.png"target ="_blank"><img src="https://preview.ibb.co/n4HjyK/edge_1.png" alt="edge_1" border="0"></a>
            ...
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: 'PlainText',
                content: `<div>Let's call the Service Desk so we can assist you in clearing your cache and cookies at <a href="tel:559-278-5000">559.278.5000</a></div>
                    		<div> Or you can <a href="http://fresnostate.edu/help/fac-staff/work-orders/general_workorder.html" target="_blank">Click Here</a> to submit a workorder.</div> `
            }));
            return;
        }
    }
    ...
    if (userIssue === null) {
        ...
        if (popUp === "Yes") {
            ...
            if (browser === null) {
                ...
                if (browser === "safari") {
                    ...
                    callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                        contentType: 'PlainText',
                        content: `<div>Let's call the Service Desk to assist you in clearing your cache and cookeis at <a href="tel:559-278-5000">559.278.5000</a></div>
                    					<div> Or <a href="http://fresnostate.edu/help/fac-staff/work-orders/general_workorder.html" target="_blank">Click Here</a>to submit a workorder.</div>`
                    }));
                }
            }
            ...
            if (browser === null) {
                ...
                if (browser === "safari") {
                    callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                        contentType: "PlainText",
                        content: `<div>Here is how to disable pop-up Window Blocker for Safari.</div>
                    ...
                    callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                        contentType: "PlainText",
                        content: `<div>Here is how to disable pop-up Window Blocker for Chrome.</div>
                    ...
                    callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                        contentType: 'PlainText',
                        content: `<div>Here is how to disabl pop-up WindowBlocker for Chrome.</div>
                                            <div>Steps to Disable pop-up blocker:
                							    <ol>
        ...
        if (userType === null) {
            ...
            callback(elicit.elicitSlot(intentRequest.sessionAttributes, "clearCacheCookies", slot_, "browser", {
                contentType: 'PlainText',
                content: `<div>Here is how to clearing your cache and cookies. If that does not work please call the Service Desk at <a href="tel:559-278-5000">559.278.5000</a> or 
            ...
            if (registration_issue === null) {
                ...
                if (browser !== null) {
                    if (browser === "safari") {
                        ...
                        callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                            contentType: 'PlainText',
                            content: `<div>Let's call the Service Desk to assist you in disabling your cache and cookies at <a href="tel:559-278-5000">559.278.5000</a> </div>
                        						<div> Or <a href="http://fresnostate.edu/help/fac-staff/work-orders/general_workorder.html" target="_blank">Click Here</a>
                        					        to submit a workorder.</div>`
                        }));
                    }
...
function popUpBlocker(intentRequest, callback) {
    ...
    if (browser !== null) {
        if (browser === "safari") {
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: "PlainText",
                content: `<div>Here is how to disabling pop-up Window Blocker for Safari.</div>
                                        <div>Steps to Disable pop-up blocker:
                							<ol>
                								<li>Select select <b>Safari</b> then <b> Preferences</b>.</li>
                                                <li> Click on <b>Security</b> at the top of the window</li>
            ...
            callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
                contentType: "PlainText",
                content: `<div>Here is how to disabling pop-up Window Blocker for Chrome.</div>
...
function dispatch(intentRequest, callback) {
    ...
    if (name === "Password_Recovery") {
        ...
        callback(elicit.close(intentRequest.sessionAttributes, 'Fulfilled', {
            contentType: 'PlainText',
            content: `<div>Lets head over to google apps page to get your account activated.</div>
